...
$woof_ext_onsales_label = apply_filters('woof_ext_custom_title_by_onsales', esc_html__('On sale', 'child-underscore'));
    ...
    <div data-css-class="woof_checkbox_sales_container" class="woof_checkbox_sales_container woof_container woof_container_onsales <?php echo esc_attr(WOOF_HELPER::generate_container_css_classes('by_onsales')) ?>">
        ...
        <div class="woof_container_inner">
            ...
            if (isset(woof()->settings['by_onsales']['view']) && woof()->settings['by_onsales']['view'] === 'switcher') {
                ...
                ?>
                <input type="checkbox" class="woof_checkbox_sales custom-sale" id="woof_checkbox_sales" name="sales" value="0" <?php checked('salesonly', woof()->is_isset_in_request_data('onsales') ? 'salesonly' : '', true) ?> />&nbsp;&nbsp;<label for="woof_checkbox_sales"><?php
