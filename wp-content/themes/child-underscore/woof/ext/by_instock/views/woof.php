...
$woof_ext_instock_label = apply_filters('woof_ext_custom_title_by_instock', __('In stock', 'child-underscore'));
...
if (isset(woof()->settings['by_instock']) AND woof()->settings['by_instock']['show']) {
    if (isset(woof()->settings['by_instock']['view']) && woof()->settings['by_instock']['view'] === 'switcher') {
        ...
        ?>
        <div data-css-class="woof_checkbox_instock_container custom-instock" class="woof_checkbox_instock_container woof_container woof_container_stock <?php echo esc_attr(WOOF_HELPER::generate_container_css_classes('by_instock')) ?>">
            <div class="woof_container_overlay_item"></div>
            <div class="woof_container_inner">
