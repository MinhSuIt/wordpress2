...
function base_items_2_shortcode($atts)
{
    ...
    ob_start();
    get_template_part('base/template-parts/items-2/index', null, compact('query', 'class', 'should_show_pagination', 'paged'));
    return ob_get_clean();
}

add_shortcode('base_items_2_shortcode', 'base_items_2_shortcode');