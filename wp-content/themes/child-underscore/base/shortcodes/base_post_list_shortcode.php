...
<?php
function base_post_list_shortcode($atts)
{
    wp_enqueue_style(
        'post-list',
...
add_shortcode('base_post_list_shortcode', 'base_post_list_shortcode');
// <?php echo do_shortcode("[base_post_list_shortcode class='custom-class' post_type='post' cat_id='1' items_per_row='2' posts_per_page='6']");
?>
