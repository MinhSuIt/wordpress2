...
<div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 <?= $class ?>">
    <?php
    $i = 1;
    ...
    ?>
            <?php echo do_shortcode(
                "[base_item_1_shortcode 
                    class='' 
                    heading='h3' 
                    title='" . get_the_title() . "' 
                    description='" . get_the_excerpt() . "'
                    img='" . (has_post_thumbnail() ? esc_url(get_the_post_thumbnail_url(get_the_ID(), 'medium')) : get_template_directory_uri() . '/assets/images/no-image.png') . "'
